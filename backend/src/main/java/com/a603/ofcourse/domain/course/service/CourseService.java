...
public class CourseService {
    ...
    public Integer addCourse(AddCourseRequestDto requestDto) {
        ...
        return courseRepository.findByHashKey(hashKey)
                .map(course -> addMyCourse(requestDto, course))
                .orElseGet(() -> addNewCourse(requestDto, hashKey));
    }
     ...
     **/private Integer addMyCourse(AddCourseRequestDto requestDto, Course course) {
     ...
     **/
    private Integer addNewCourse(AddCourseRequestDto requestDto, String hashKey) {
        Course newCourse = Course.builder()
                .title(requestDto.getCourseTitle())
                .hashKey("")
                .build();
        newCourse.updateHashKey(hashKey);
        addMyCourse(requestDto, newCourse);
